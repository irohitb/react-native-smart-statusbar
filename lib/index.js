...
const SafeAreaDecider = ({ statusBarHiddenForNotch = false, statusBarHiddenForNonNotch = false, backgroundColor, ...rest }) => {
    ...
    if (deviceHaveNotch) {
        return (React.createElement(View, { style: {
            ...
            React.createElement(StatusBar, Object.assign({}, rest, { translucent: true, hidden: statusBarHiddenForNotch }))));
    }
        ...
        return (React.createElement(View, { style: {
            ...
            React.createElement(StatusBar, Object.assign({}, rest, { translucent: true, hidden: statusBarHiddenForNonNotch }))));
    }
    else if (!deviceHaveNotch && Platform.OS === 'android') {
        return (React.createElement(StatusBar, Object.assign({}, rest, { backgroundColor: backgroundColor, hidden: statusBarHiddenForNonNotch })));
    }
    else {
        return null;
    }
